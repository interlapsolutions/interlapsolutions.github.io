...
/* --------------------------------------------------------	
   ...
   --------------------------------------------------------	*/	
	...
	(function() {
		...
		$('#team-andy').tooltip({animation:true, title:"07855 764 282"})
		$('#team-ian').tooltip({animation:true, title:"07974 198 092"})
		$('#team-paul').tooltip({animation:true, title:"07888 555 222"})
